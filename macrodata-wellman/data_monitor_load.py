...
def get_fred_data(freq,typedef):
    ...
    series =   {
            ...
            'IPDNBS': 'ydefl_nonfarm',        # Implicit Price Deflator in nonfarm business sector (from productivity and costs series)
            ...
            'PRS85006111':'ulc',              # Unit labor costs for all employed persions in the nonfarm business sector (%chg from Q one year ago, not ideal)
            'ULCNFB':'ulc_level',             # Unit labor cost level
            'PRS85006173':'laborshare',       # Labor share from the productivity relase (indexed to 2012=100, value at that date is 56.4)
            ...
            'ECIALLCIV': 'eci',               # BLS employment cost index
